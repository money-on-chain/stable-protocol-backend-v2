...
import { MicroLiquidationExecute } from '../../src/moc-v2/admin.js'
...
const main = async () => {
    ...
    const { receipt, filteredEvents } = await MicroLiquidationExecute(web3, dContracts, configProject, feeRecipient)
}
